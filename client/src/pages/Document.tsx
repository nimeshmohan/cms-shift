        ...
        <div className="container mx-auto px-4 py-12">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-bold mb-3">CMShift Documentation</h1>
              <p className="text-lg text-muted-foreground">
                Learn how to use CMShift to automate your content migration and scraping workflow.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <CardTitle>What is CMShift?</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  CMShift is a powerful automation tool that allows you to scrape content from any website and automatically 
                  publish it to your Webflow CMS. No coding required.
                </p>
                <p>
                  Simply point CMShift at a URL, map CSS selectors to your CMS fields, and watch as your CMS fills itself 
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-2">How to Use CMShift</h2>
              ...
              {[
                {
                  ...
                  description: "Start by authenticating with your Webflow account. CMShift will securely access your collections and fields.",
                  icon: Code2,
                },
                {
                  step: "2",
                ...
                },
                {
                  ...
                  description: "Use CSS selectors to tell CMShift exactly which elements on the page contain your data. Map each selector to the corresponding Webflow field.",
                  icon: Layers,
                },
                {
                  step: "4",
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  description: "Import multiple URLs at once. Watch the progress as CMShift processes your content.",
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }}>
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">Get the most out of CMShift:</p>
            </div>
